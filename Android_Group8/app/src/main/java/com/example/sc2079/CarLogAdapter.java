...
public class CarLogAdapter extends RecyclerView.Adapter<CarLogAdapter.ViewHolder> {
    private ArrayList<String> logList;
    private RecyclerView recyclerView;

    public CarLogAdapter(ArrayList<String> logList, RecyclerView recyclerView) {
